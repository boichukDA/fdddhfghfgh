...
public class AccountHeaderBuilder {
    ...
    public AccountHeaderBuilder withHeaderBackgroundColor(@ColorRes int headerBackgroundColorRes) {
        this.mHeaderBackgroundColor = headerBackgroundColorRes;
        return this;
    }
    ...
    public AccountHeader build() {
        ...
        }else if (mHeaderBackgroundColor!=-1)
            mAccountHeaderBackground.setBackgroundResource(mHeaderBackgroundColor);
